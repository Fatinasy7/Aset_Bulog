...
Route::middleware('auth')->group(function () {
    Route::controller(FrontendPageController::class)->group(function () {
        ...
        Route::get('/frontend/reports', 'reportsIndex')->name('frontend.reports.index')->middleware('role:admin_it,manajemen');
        Route::get('/frontend/reports/export', 'reportsExport')->name('frontend.reports.export')->middleware('role:admin_it,manajemen');
        Route::get('/frontend/reports/download', 'reportsDownload')->name('frontend.reports.download')->middleware('role:admin_it,manajemen');
        ...
        Route::get('/frontend/dashboard-management', 'dashboardManagement')->name('frontend.dashboard.management')->middleware('role:admin_it,manajemen');
