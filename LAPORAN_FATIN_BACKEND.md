...
| Dashboard summary | `app/Http/Controllers/DashboardController.php`, `routes/api.php` | Endpoint `GET /api/dashboard/summary` untuk ringkasan metrik dashboard aset |
